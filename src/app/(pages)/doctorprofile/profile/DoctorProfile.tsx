        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="mt-4 flex gap-10 text-gray-700 text-sm">
            <div>
              ...
              <p><span className="text-[22px] font-bold text-black">16</span> Years of experience since 2011</p>
            </div>
            <div>
              <p className="font-semibold  py-3 text-[#2b6771]">Rating</p>
              <p><span className="text-[22px] font-bold text-black">5</span> - This Doctor rating is Good</p>
            </div>
          </div>
        </div>
      </div>
